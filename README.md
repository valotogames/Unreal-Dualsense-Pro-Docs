...
<h1 align="center">Middleware Unreal-Dualsense <small style="font-size: 16px">pro</small></h1>
...
<a href="https://github.com/valotogames/Unreal-Dualsense-Pro-Docs/discussions">Suggest a Feature</a> · 
<a href="https://github.com/valotogames/Unreal-Dualsense-Pro-Docs/wiki">Documentation</a>
  
</p>

<p align="center">
<img src="https://img.shields.io/badge/License-other-blue?style=for-the-badge" alt="License">     
<img src="https://img.shields.io/badge/Unreal%20Engine-5.2+-blue?style=for-the-badge&logo=unrealengine" alt="Unreal Engine 5.2+" title="Unreal Engine 5.2+">
</p>
<p align="center">
<img src="https://img.shields.io/badge/Windows-0078D6?style=for-the-badge&logo=data:image/svg%2bxml;base64," alt="Platform: Windows" title="Platform: Windows">    
...
Go to the official page on the Unreal Engine Marketplace (FAB): **[Middleware v3.1.0 - FAB](https://www.fab.com/listings/d0836635-91a8-42cb-a78f-d34456cc042c)**
